 ...
 */
final class Version20231110110012 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_book ADD CONSTRAINT FK_B164EFF87162BA4C FOREIGN KEY (status2_id) REFERENCES status (id)');
